...
function Card({
  ...
  return (
    <div
      className={cn(
        "group/card flex flex-col gap-4 overflow-hidden rounded-md border border-border/60 bg-card py-4 text-card-foreground text-xs/relaxed shadow-sm has-[>img:first-child]:pt-0 has-data-[slot=card-footer]:pb-0 data-[size=sm]:gap-2 data-[size=sm]:py-3 data-[size=sm]:has-data-[slot=card-footer]:pb-0 dark:shadow-none *:[img:first-child]:rounded-none *:[img:last-child]:rounded-none",
        className
      )}
      data-size={size}
      data-slot="card"
