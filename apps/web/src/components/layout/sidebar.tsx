          ...
          <div key={group.label}>
            {!collapsed && (
              <div className="mb-2 px-4">
                <span className="inline-block rounded-sm border border-sidebar-border bg-sidebar-accent/40 px-2 py-0.5 font-bold text-[10px] text-sidebar-foreground/60 uppercase tracking-widest">
                  {group.label}
                </span>
              </div>
            )}
