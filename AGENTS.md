...
- **Hardening producción de generación RIPS-FEV**:
  ...
  - **Trazabilidad por servicio**: `rips_export_encounter` ahora almacena links por servicio generado con `serviceType`, `serviceConsecutive` y `userConsecutive` reales. Migration `0007_rips_export_service_links.sql` reemplaza el índice único por encuentro con uno por servicio.
